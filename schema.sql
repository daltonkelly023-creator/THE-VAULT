...
create table if not exists public.products (
  ...
  -- storage paths (not public URLs) — frontend builds signed/public URLs from these
  hero_image_path text,          -- single cover image for listing thumbnails
...
-- Replace image paths with your own after uploading to the vault-assets bucket.
...
(
  ...
  'black-titanium',
  'photo_only',
  'hero/placeholder-5.jpg',
  '{}',
  true,
  'Raw Diamond',
  '0.85 ct',
  'Mined from the deepest kimberlite pipe. The raw stone is left uncut by request. Imperfection as the ultimate statement.',
